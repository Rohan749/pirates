...
const CountDown = React.memo(({ targetDate }: countInterface) => {
  ...
  return (
    <>
      <div className="countdown flex h-full justify-between gap-5 w-full md:pt-28 items-center md:items-start 2xl:pt-0 2xl:items-center opacity-0">
