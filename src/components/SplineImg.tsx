...
const SplineImg = ({handleSplineLoad, loading}:splineImgInterface) => {
  ...
  return (
    <div className='w-full overflow-y-hidden h-full'>
      <Spline onLoad={handleSplineLoad} scene='https://prod.spline.design/L2Q7hU0gZW56K3AA/scene.splinecode' className='spline-section min-h-[100vh] 2xl:min-h-[70vh] opacity-[0]'   />
