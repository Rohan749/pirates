...
const SplineImg = ({handleSplineLoad, loading}:splineImgInterface) => {
  ...
  return (
    <div className=' absolute w-full top-0'>
      <Spline onLoad={handleSplineLoad} scene='https://prod.spline.design/L2Q7hU0gZW56K3AA/scene.splinecode' className='spline-section min-h-[100vh] opacity-[0.6] md:opacity-[0.9]'   />
